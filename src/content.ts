  ...
  projects: [
    ...
    },
    {
      ...
      troubleshooting: [
        ...
        '최근 학습 과목 페이지로 이동한 경우에는 [클래스 홈] 버튼을 클릭한 뒤 학습 과목 카드의 [전체 보기] 버튼을 클릭해 학습 과목 목록 페이지로 복귀하고, 해당 케이스는 Fail로 처리했습니다.',
        '학습 과목 목록 페이지로 복귀한 이유는 다음 테스트의 사전 조건이 학습 과목 목록 페이지이기 때문이며, 이후 SANDBOX 과목을 클릭해 흐름을 이어갔습니다.',
      ],
      improvements: [
      ...
      bugReport: {
        ...
        reproduction: '게시판 글쓰기 페이지에서 필수 입력값을 작성한 뒤 [저장] 버튼을 1초 이내 연속 2회 이상 클릭하고 [글 목록] 버튼을 클릭',
